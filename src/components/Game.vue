...
export default defineComponent({
  components: { GameBottomMiddle, GameBottomUpper, GameCursor, GameTopLower, GameTopMiddle, GameTopUpper, GameMiddle, SkinSprites, BaseSvg },
  setup () {
    // SVG 高度信息
    ...
    const height = computed(() => {
      ...
      // 游戏底部高度
      const heightBottom = GAME_BOTTOM_UPPER.height + GAME_BOTTOM_MIDDLE.height
